document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateApparenceCarte(card, statusId, statusText) {
  ...
  document.querySelectorAll(".vente-card").forEach((card) => {
    ...
    const statusText = card
      ...
      .textContent.trim();
    updateApparenceCarte(card, statusId, statusText);
  });
  ...
  document.querySelectorAll(".update-status-form").forEach((form) => {
    form.addEventListener("submit", function (e) {
      ...
      fetch(form.action, {
        ...
        .then((data) => {
          if (data.success) {
            updateApparenceCarte(card, data.newStatusId, data.newStatusText);
